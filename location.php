...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Auto S Cristóvão - Localização</title>
                            ...
                            <div class="col-4">
                                <div class="top-bar-item">
                                    ...
                                    <div class="top-bar-text">
                                        <h3>Aberto</h3>
                                        <p><p></p> 9:00 - 12:30 <p></p>14:00 - 18:30</p>
            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="ml-auto">
                            <a class="btn btn-custom" href="#">Marcações</a>
                        </div>
                    </div>
                </nav>
            </div>
                            ...
                            <div class="col-md-6">
                                <div class="location-item">
                                    ...
                                    <div class="location-text">
                                        <h3>Auto S Cristovao</h3>
                                        <p>Rua dos Namorados,42 <p>  3060-167 Cantanhede </p> </p>
                                        <p><strong>Tell:</strong>938582026</p>
                                    </div>
                                </div>
                            </div>
                        </div>              
                          <div>
                        <div style="width: 200%"><iframe scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Rua%20dos%20Namorados%2044,%203060-133%20Cantanhede+(Auto%20S.%20Cristovao)&amp;t=p&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" width="100%" height="600" frameborder="0"><a href="https://www.maps.ie/distance-area-calculator.html">measure area map</a></iframe></div>
                </div>
            </div>
            </div>
        </div>
